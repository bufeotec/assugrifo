                                    ...
                                    foreach ($ventas as $al){
                                        ...
                                        <tr <?= $stylee?>>
                                            ...
                                            <td style="text-align: left">
                                                <a target="_blank" type="button" title="Ver detalle" class="btn btn-primary" style="color: white" href="<?php echo _SERVER_. 'ventas/ver_venta/' . $al->id_venta;?>" ><i class="fa fa-eye ver_detalle"></i></a>
                                                <?php
                                                if($al->anulado_sunat == "0" && ($al->venta_tipo_envio == "0" || $al->venta_tipo_envio == "1") && $al->venta_tipo != '03'){
                                                    ...
                                                    <?php }
                                                    ?>
                                                    <a id="btn_enviar<?= $al->id_venta;?>" type="button" title="Enviar a Sunat" class="btn btn-success" style="color: white" onclick="preguntar('¿Está seguro que desea enviar a la Sunat este Comprobante?','enviar_comprobante_sunat','Si','No',<?= $al->id_venta;?>)"><i class="fa fa-check margen"></i></a>
                                                    <?php
                                                }
                                                if($al->venta_tipo == "03" and $al->anulado_sunat == "0"){
                                                    ?>
                                                    <a target="_blank" type="button" id="btn_anular_anular<?= $al->id_venta;?>" class="btn btn-danger" style="color: white" onclick="preguntar('¿Está seguro que desea anular este Comprobante?','anular_boleta_cambiarestado','Si','No',<?= $al->id_venta;?>, '1')" ><i class="fa fa-ban"></i></a>
                                                    <?php
                                                }else{
                                                    if($al->anulado_sunat == "1"){ ?>
