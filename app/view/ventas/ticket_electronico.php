...
$printer->text("REFERENCIA  : $datoto" . "\n");
...
$printer->text("** Una vez salida la mercaderia, no se aceptan" . "\n");
$printer->text("cambios ni devoluciones **" . "\n");
