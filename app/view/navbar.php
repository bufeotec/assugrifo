    ...
    <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar" >
        ...
        <li class="nav-item active">
            <a class="nav-link" href="<?= _SERVER_;?>">
                ...
                <span style="color:rgba(255,255,255,1);font-size: 11px">Inicio</span></a>
        </li>
        <!-- Divider -->
        <hr class=" -divider">
        <!-- Heading -->
        <div class="sidebar-heading" style="color:rgba(255,255,255,1);font-size: 11px">
            Menú
        </div>
        <?php
        ...
        foreach ($navs as $nav){
            ...
            <li class="nav-item">
                <a class="<?= $nav_link;?>" href="#" data-toggle="collapse" data-target="#collapseMenu<?= $raioz;?>" aria-expanded="<?= $aria_expanded;?>" aria-controls="collapseMenu<?= $raioz;?>">
                    <i style="color:white;font-size: 11px" class="<?= $nav->menu_icono;?>"></i>
                    <span style="color:rgba(255,255,255,1);font-size: 11px" class="font-weight-bold"><?= $nav->menu_nombre;?></span>
                </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="row" style="display: none">
                <!--<div class="col-lg-2">
                    <button class="boton_estadistica"><i class="fa fa-line-chart"></i> Estadísticas</button>
                </div>-->
                <div class="col-lg-3">
                    <b><a href="<?= _SERVER_ ?>Ventas/realizar_venta"><button class="boton_vender"><i class="fa fa-credit-card"></i> Realizar Venta</button></a></b>
                </div>
                <div class="col-lg-3">
                    <b><a href="<?= _SERVER_ ?>Ventas/historial_ventas_enviadas"><button class="boton_vendido"><i class="fa fa-money"></i> Ventas Declaradas</button></a></b>
                </div>
                <div class="col-lg-3">
                    <b><a href="<?= _SERVER_ ?>Correlativo/editar"><button class="boton_remision"><i class="fa fa-check-square-o"></i> Correlativos</button></a></b>
                </div>
                <div class="col-lg-3">
                    <b><a href="<?= _SERVER_ ?>Proforma/realizar_proforma"><button class="boton_proforma"><i class="fa fa-file-text"></i> Proformas</button></a></b>
                </div>
                <!--<div class="col-lg-2">
                    <b><button class="boton_compras"><i class="fa fa-tags"></i> Compras</button></b>
                </div>-->
            </div>
            <div class="row" style="display: none">
                <div class="col-lg-3">
                    <b><a href="<?= _SERVER_ ?>Reporte"><button class="boton_reportes"><i class="fa fa-pie-chart"></i> Reportes</button></a></b>
                </div>
                <div class="col-lg-3">
                    <b><a href="<?= _SERVER_ ?>Clientes"><button class="boton_clientesyproveedores"><i class="fa fa-truck"></i> Clientes y Proveedores</button></a></b>
                </div>
                <div class="col-lg-3">
                    <b><a href="<?= _SERVER_ ?>Inventario/productos"><button class="boton_productos"><i class="fa fa-diamond"></i> Productos</button></a></b>
                </div>
                <div class="col-lg-3">
                    <b><a href="<?= _SERVER_ ?>Egresos/egresos"><button class="boton_egresos"><i class="fa fa-balance-scale"></i> Egresos</button></a></b>
                </div>
                <!--<div class="col-lg-2">
                    <b><button class="boton_configuracion"><i class="fa fa-cog"></i> Configuración</button></b>
                </div>
                <div class="col-lg-2">
                    <b><button class="boton_soporte"><i class="fa fa-medkit"></i> Soporte / Ayuda</button></b>
                </div>
                <div class="col-lg-2">
                    <b><a href="http://localhost/fire/Admin/finalizar_sesion"><button class="boton_salir"><i class="fa fa-power-off"></i> Cerrar Sesión</button></a></b>
                </div>-->
            </div>